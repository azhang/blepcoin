---
aclayout: post
title:  "Privatix: Internet broadband marketplace"
date:   2019-05-07
categories:  vpn
...
So, is the utility of the token is so high that it's worthwhile for people to overcome the network effects and cognitive overhead of having a new application specific token? There are 3 key ways to increase the chances, and the team is doing all three:
...
GUI based on [electronjs](https://electronjs.org/) and [redux](https://redux.js.org/).
